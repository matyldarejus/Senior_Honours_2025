...
if __name__ == '__main__':
    ...
    phase_space_file = f'/disk04/mrejus/sh/samples/{model}_{wind}_{snap}_phase_space.h5'
    ...
    ax[0][0].annotate('Inner CGM', xy=(0.65, 0.85), xycoords='axes fraction', bbox=dict(boxstyle="round", fc="w", ec="black", lw=1.2), fontsize=20)
    ax[1][0].annotate('Outer CGM', xy=(0.65, 0.85), xycoords='axes fraction', bbox=dict(boxstyle="round", fc="w", ec="black", lw=1.2), fontsize=20)

    #plt.tight_layout()
    fig.subplots_adjust(wspace=0., hspace=0.)
    plt.savefig(f'{plot_dir}{model}_{wind}_{snap}_deltaTN_{line}.png', format='png')
