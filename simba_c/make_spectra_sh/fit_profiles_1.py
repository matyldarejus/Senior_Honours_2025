...
if __name__ == '__main__':
    ...
    spec_file = [i for i in listdir if ion in i and if i in range(0, 1000)] # Check how many repeats this does, if I need to run it once or over x number of galaxies
